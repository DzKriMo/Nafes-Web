...
function left() {
  testText.innerHTML =
    '<h4 class="hh2" style="text-align: center" id="speech">“You Can\'t See Me”</h4>';
  leftArrow.src = "/img/leftt.png";
  rightArrow.src = "/img/rightt.png";
  pbio.innerHTML =
    '<p class="pp" style="text-align: center" id="bio"> You literally can\'t <br> See him</p>';
  pname.innerHTML =
    '<h6 class="hh2" style="text-align: center" id="Name">John Cena</h6>';
